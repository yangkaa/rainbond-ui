...
const appPublish = {
  ...
  'appPublish.btn.record.list.label.is_platform_plugin':'Platform Plugin',
  'appPublish.btn.record.list.label.plugin_id':'Plugin ID',
  'appPublish.btn.record.list.label.plugin_name':'Plugin Name',
  'appPublish.btn.record.list.label.plugin_type':'Plugin Type',
...
const topology = {
  ...
  'topology.g6.tooltip.status':'Status',
  'topology.g6.tooltip.instances':'Instances',
  'topology.g6.tooltip.memory':'Memory',
  'topology.g6.tooltip.internet':'External access enabled',
  'topology.g6.menu.link':'Create Dependency',
  'topology.g6.menu.build':'Build Component',
  'topology.g6.menu.update':'Update Component',
  'topology.g6.menu.start':'Start Component',
  'topology.g6.menu.restart':'Restart Component',
  'topology.g6.menu.stop':'Stop Component',
  'topology.g6.menu.terminal':'Web Terminal',
  'topology.g6.menu.delete':'Delete Component',
  'topology.g6.link_mode.tip':'Link mode: drag from the source component to the target component to create a dependency',
  'topology.g6.link_mode.exit':'Exit',
  'topology.g6.port.opened':'External port opened successfully',
  'topology.g6.port.closed':'External port closed',
  'topology.g6.dependency.exists':'The dependency already exists',
  'topology.g6.dependency.failed':'Failed to create dependency',
  'topology.g6.dependency.removed':'Dependency removed',
  'topology.g6.network.error':'Network error, please try again later',
  'topology.g6.edge.close_port_title':'Confirm closing external port',
  'topology.g6.edge.close_port_desc':'Are you sure you want to close the external port of {name}?',
  'topology.g6.edge.delete_dep_title':'Confirm deleting dependency',
  'topology.g6.edge.delete_dep_desc':'Are you sure you want to delete the dependency {source} → {target}?',
  'topology.dependency_config.title':'Create dependency connection',
  'topology.dependency_config.summary':'The topology link has been created. Configure the connection details below so {source} can access {target}.',
  'topology.dependency_config.port_label':'Target port',
  'topology.dependency_config.port_placeholder':'Select a target port',
  'topology.dependency_config.port_option':'Port {port} / {protocol}',
  'topology.dependency_config.alias_title':'Connection Alias',
  'topology.dependency_config.alias_desc':'This alias is used as the prefix of injected environment variables. Changing it will rename the injected variables.',
  'topology.dependency_config.alias_input_label':'Connection alias',
  'topology.dependency_config.alias_placeholder':'Enter a connection alias',
  'topology.dependency_config.alias_hint':'Uppercase aliases are recommended, for example DB or REDIS.',
  'topology.dependency_config.alias_required':'Please enter a connection alias',
  'topology.dependency_config.alias_invalid':'The alias must start with an uppercase letter and contain only uppercase letters, numbers, and underscores',
  'topology.dependency_config.env_title':'Environment variables to be injected',
  'topology.dependency_config.effect_update':'Takes effect after update',
  'topology.dependency_config.effect_restart':'Takes effect on next start',
  'topology.dependency_config.usage_title':'How do I use it in code?',
  'topology.dependency_config.notice_title':'Important note',
  'topology.dependency_config.notice_desc':'Rainbond injects the target service address as connection environment variables. Use the HOST and PORT variables instead of hardcoding addresses.',
  'topology.dependency_config.empty_envs':'No connection information is available for the selected port',
  'topology.dependency_config.empty_ports':'No configurable internal ports are available on the target component right now. Please check the component ports page and try again later.',
  'topology.dependency_config.load_failed':'Failed to load dependency configuration. Please try again later.',
  'topology.dependency_config.cancel':'Update later',
  'topology.dependency_config.submit_update':'Save and update service',
  'topology.dependency_config.submit_save':'Save configuration',
}
const JavaMaven = {
  ...
  'JavaMaven.start':'Start Command (Optional)',
  'JavaMaven.start_input':'Leave empty to use the Paketo default process',
...
const appVersionMock = {
  'appVersion.page.title': 'App Versions',
  'appVersion.page.content': 'Current app: {appName}',
  'appVersion.history.title': 'Version Timeline',
  'appVersion.action.create': 'Create Snapshot',
  ...
  'appVersion.notification.rollback': 'Switched to the selected snapshot baseline',
  'appVersion.notification.publish': 'Mock published snapshot',
  'appVersion.hero.pendingTitle': 'New application changes detected',
  'appVersion.hero.stableTitle': 'The app is synced with the latest snapshot baseline',
  'appVersion.hero.pendingTag': 'Pending Snapshot',
  'appVersion.hero.stableTag': 'Synced',
  'appVersion.hero.stableDesc': 'The current app matches the latest snapshot baseline. You can rollback or publish from snapshot history.',
  'appVersion.hero.hint.pending': 'Create a snapshot before publishing it',
  'appVersion.hero.hint.stable': 'The button will light up again after components change',
  'appVersion.meta.current': 'Current Baseline',
  'appVersion.meta.count': 'Snapshots',
  'appVersion.meta.scope': 'Stage',
  'appVersion.snapshot.current': 'Current Baseline',
  'appVersion.snapshot.published': 'Published',
  'appVersion.snapshot.meta': 'Created At',
  'appVersion.drawer.basic': 'Basic Info',
  'appVersion.drawer.stats': 'Snapshot Overview',
  'appVersion.empty': 'No application snapshots yet',
  'appVersion.modal.create.title': 'Create Snapshot',
