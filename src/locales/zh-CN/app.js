...
const appPublish = {
  ...
  'appPublish.btn.record.list.label.is_platform_plugin':'平台插件',
  'appPublish.btn.record.list.label.plugin_id':'插件ID',
  'appPublish.btn.record.list.label.plugin_name':'插件名称',
  'appPublish.btn.record.list.label.plugin_type':'插件类型',
  ...
  'appPublish.btn.record.creactAppModel.pages.label.max16':'请输入创建的应用模版名称，最大长度16位',
...
const topology = {
  ...
  'topology.g6.tooltip.status':'状态',
  'topology.g6.tooltip.instances':'实例数',
  'topology.g6.tooltip.memory':'内存',
  'topology.g6.tooltip.internet':'已开通外网访问',
  'topology.g6.menu.link':'创建依赖',
  'topology.g6.menu.build':'构建组件',
  'topology.g6.menu.update':'更新组件',
  'topology.g6.menu.start':'启动组件',
  'topology.g6.menu.restart':'重启组件',
  'topology.g6.menu.stop':'关闭组件',
  'topology.g6.menu.terminal':'web终端',
  'topology.g6.menu.delete':'删除组件',
  'topology.g6.link_mode.tip':'连线模式：从源组件按住拖到目标组件以创建依赖',
  'topology.g6.link_mode.exit':'退出',
  'topology.g6.port.opened':'对外端口开启成功',
  'topology.g6.port.closed':'对外端口已关闭',
  'topology.g6.dependency.exists':'当前应用已被关联',
  'topology.g6.dependency.failed':'创建依赖失败',
  'topology.g6.dependency.removed':'依赖关系已删除',
  'topology.g6.network.error':'网络错误，请稍后重试',
  'topology.g6.edge.close_port_title':'确认关闭对外端口',
  'topology.g6.edge.close_port_desc':'确定要关闭组件 {name} 的对外端口吗？',
  'topology.g6.edge.delete_dep_title':'确认删除依赖',
  'topology.g6.edge.delete_dep_desc':'确定要删除 {source} → {target} 的依赖关系吗？',
  'topology.dependency_config.title':'建立依赖连接',
  'topology.dependency_config.summary':'已建立拓扑连接。为了让 {source} 能够访问 {target}，您需要配置以下连接信息。',
  'topology.dependency_config.port_label':'目标端口',
  'topology.dependency_config.port_placeholder':'请选择目标端口',
  'topology.dependency_config.port_option':'端口 {port} / {protocol}',
  'topology.dependency_config.alias_title':'连接别名 (Connection Alias)',
  'topology.dependency_config.alias_desc':'此别名将作为环境变量的前缀，修改别名会改变注入的变量名。',
  'topology.dependency_config.alias_input_label':'连接别名',
  'topology.dependency_config.alias_placeholder':'请输入连接别名',
  'topology.dependency_config.alias_hint':'建议使用全大写，如 DB、REDIS。',
  'topology.dependency_config.alias_required':'请输入连接别名',
  'topology.dependency_config.alias_invalid':'连接别名需以大写字母开头，只能包含大写字母、数字和下划线',
  'topology.dependency_config.env_title':'即将注入的环境变量',
  'topology.dependency_config.effect_update':'更新后生效',
  'topology.dependency_config.effect_restart':'下次启动时生效',
  'topology.dependency_config.usage_title':'如何在代码中使用？',
  'topology.dependency_config.notice_title':'重要提示',
  'topology.dependency_config.notice_desc':'Rainbond 会将目标服务地址注入为连接环境变量。请优先使用环境变量中的 HOST 和 PORT，不要在代码中写死目标地址。',
  'topology.dependency_config.empty_envs':'当前端口暂无可展示的连接信息',
  'topology.dependency_config.empty_ports':'当前目标组件暂无可配置的内部端口，请稍后在组件端口页检查后再试。',
  'topology.dependency_config.load_failed':'依赖配置加载失败，请稍后重试',
  'topology.dependency_config.cancel':'稍后更新',
  'topology.dependency_config.submit_update':'保存并更新服务',
  'topology.dependency_config.submit_save':'保存配置',
}
...
const appVersionMock = {
  ...
  'appVersion.history.title': '版本时间线',
  'appVersion.action.create': '创建快照',
  ...
  'appVersion.notification.rollback': '已切换到选中的快照基线',
  'appVersion.notification.publish': '已模拟发布快照',
  'appVersion.hero.pendingTitle': '检测到新的应用变更',
  'appVersion.hero.stableTitle': '当前应用已同步到快照基线',
  'appVersion.hero.pendingTag': '待快照',
  'appVersion.hero.stableTag': '已同步',
  'appVersion.hero.stableDesc': '当前应用与最近一次快照保持一致，可以直接从历史快照发起回滚或发布。',
  'appVersion.hero.hint.pending': '建议先快照，再继续发布',
  'appVersion.hero.hint.stable': '组件再次变化后会重新亮起',
  'appVersion.meta.current': '当前基线',
  'appVersion.meta.count': '快照数量',
  'appVersion.meta.scope': '当前阶段',
  'appVersion.snapshot.current': '当前基线',
  'appVersion.snapshot.published': '已发布',
  'appVersion.snapshot.meta': '创建于',
  'appVersion.drawer.basic': '基础信息',
  'appVersion.drawer.stats': '快照概览',
  'appVersion.empty': '当前还没有应用快照',
  'appVersion.modal.create.title': '创建应用快照',
